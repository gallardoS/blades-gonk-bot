...
@Slf4j
public class CurrentCommandFun extends Command {
    ...
    String[] aliases = new String[]{"eufun","onlinefun"};

    public CurrentCommandFun(){
        super.name = "onlineFun";
        super.aliases = aliases;
        super.help = "Displays the current players online for EU Fun";
    }
    ...
    public EmbedBuilder buildEmbedMessage(int currentPlayers, JSONObject jsonDashboard) throws IOException {
        ...
        embedMessage.setTitle("EU Fun - Current players: " + currentPlayers + "/" + jsonDashboard.getString("MaxPlayers"));
    ...
    public EmbedBuilder getEmbedMessageError(){
        ...
        embedMessageError.setTitle("EU Fun - Error");
