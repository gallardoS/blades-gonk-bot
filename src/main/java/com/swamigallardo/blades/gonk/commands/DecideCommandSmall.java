...
@Slf4j
public class DecideCommandSmall extends Command {
    List<String> emojiList = Arrays.asList(":white_check_mark:",":x:");
    String bfhIcon = "https://i.imgur.com/05yRTv7.png";

    public DecideCommandSmall(){
        super.name = "scrimformatsmall";
    }

    @Override
    protected void execute(CommandEvent event) {
        List<String> formatsList = Arrays.asList("Specials Off ", "Specials On ");
