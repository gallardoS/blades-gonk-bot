...
public class CurrentCommand2 extends Command {
    ...
    String urlPlayers = "http://85.214.246.136:39500/live/players";
    String urlDashboard = "http://85.214.246.136:39500/live/dashboard";
    ...
    public EmbedBuilder buildEmbedMessage(int currentPlayers, JSONObject jsonDashboard) throws IOException {
        ...
        embedMessage.setTitle("EU Public 2 - Current players: " + currentPlayers + "/" + jsonDashboard.getString("MaxPlayers"));
