...
@Slf4j
public class CurrentCommandHeroes extends Command {

    PlayerService playerService = new PlayerService();
    DashboardService dashboardService = new DashboardService();
    MapTranslator mapTranslator = new MapTranslator();

    String urlPlayers = "http://85.214.246.136:64007/live/players";
    String urlDashboard = "http://85.214.246.136:64007/live/dashboard";

    String bfhIcon = "https://i.imgur.com/05yRTv7.png";

    String authHeaderValue = "Basic QmxhZDM6RnVqaTIwMjAq";

    String[] aliases = new String[]{"euheroes","onlineheroes"};

    public CurrentCommandHeroes(){
        super.name = "onlineHeroes";
        super.aliases = aliases;
        super.help = "Displays the current players online for EU Heroes";
    }
